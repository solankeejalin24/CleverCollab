...
import { CalendarIcon, User2Icon, ClockIcon, LinkIcon, InfoIcon } from 'lucide-react'
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Card
            ref={setNodeRef}
            style={style}
            className="cursor-grab active:cursor-grabbing border-primary/20 dark:border-primary/10 hover:border-primary/50 dark:hover:border-primary/30 bg-card transition-all overflow-hidden"
            {...attributes}
            {...listeners}
          >
